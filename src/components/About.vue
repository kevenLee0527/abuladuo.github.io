  ...
  <div class="task">
    ...
    <div class="main">
        ...
        <div :style="{float:'right'}">
          <a-button :style="{marginLeft:'20px'}" type="primary" @click="showModal">添加关于</a-button>
        </div>
        <table border="1" cellspacing="0">
      <thead>
        <th :style="{width:'5%'}"><span>ID</span> </th>
        <th><span>关于名称</span></th>
    ...
    <a-modal :style="{top:'20px'}" width="900px" title="添加关于" v-model="visible" @ok="handleOk" okText="确定" cancelText="取消">
      <a-row>
        <a-col :span="3">
